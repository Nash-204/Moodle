...
$string['modulename'] = 'GM Tracker';
$string['pluginname'] = 'GM Tracker';
$string['taskprocessemailqueue'] = 'Process GMTracker email queue';

// Event strings
$string['eventemailsent'] = 'GMTracker email sent';
$string['eventemailfailed'] = 'GMTracker email failed';

// Logging strings
$string['email sent'] = 'Email sent';
$string['email failed'] = 'Email failed';

// Task event strings
$string['eventtaskstarted'] = 'GMTracker task started';
$string['eventtaskcompleted'] = 'GMTracker task completed';

// Logging strings for tasks
$string['task started'] = 'Task started';
$string['task completed'] = 'Task completed';

// Event strings
$string['eventemailsqueued'] = 'GMTracker emails queued';

// Logging strings
$string['emails queued'] = 'Emails queued';


// Email invitation settings
$string['emailinvitations'] = 'Email Invitations';
$string['sendinvites'] = 'Send email invitations to participants';
$string['recipienttype'] = 'Send invitations to';
$string['allparticipants'] = 'All course participants';
$string['selectgroups'] = 'Select specific groups';
$string['selectusers'] = 'Select specific users';
$string['selectedgroups'] = 'Groups to invite';
$string['allgroups'] = 'All groups';
$string['selectedusers'] = 'Users to invite';
$string['selectedusers_placeholder'] = 'Enter one email per line:\nstudent1@university.edu\nstudent2@university.edu';
$string['selectatleastoneuser'] = 'Please select at least one user';
$string['invalidemails'] = 'Invalid email addresses found';
$string['availableusers'] = 'Available Users in this Course';
$string['availableusers_help'] = 'You can copy and paste emails from this list:';