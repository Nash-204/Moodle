...
// Queued system
$string['invitequeuedsuccess'] = 'Quiz invitations queued successfully! {$a} batch(es) created and will be sent via background processing.';
$string['noeligibleusers'] = 'No eligible users found to send quiz invitations to.';
$string['taskprocessquizemailqueue'] = 'Process Gamification quiz email queue';

// Event strings
$string['eventquizemailsqueued'] = 'Quiz emails queued';
$string['eventquizemailsent'] = 'Quiz email sent';
$string['eventquiztaskstarted'] = 'Quiz task started';
$string['eventquiztaskcompleted'] = 'Quiz task completed';
$string['eventquizemailfailed'] = 'Quiz email failed';
$string['eventquizbatchfailed'] = 'Quiz batch failed';

// Quiz Invite Page
$string['sendquizinvites'] = 'Send Quiz Invitations';
$string['quizinfo'] = 'Quiz Information';
$string['quizname'] = 'Quiz Name';
$string['sendinvitationsto'] = 'Send invitations to';
$string['groupstoinvite'] = 'Groups to invite';
$string['userstoinvite'] = 'Users to invite';
...
$string['availableusers_help'] = 'List of enrolled users in this course (copy and paste emails to the Users to invite field above)';
