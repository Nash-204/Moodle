...
class block_gamification_renderer extends plugin_renderer_base {
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (toggleSwitch) {
                    toggleSwitch.addEventListener('change', function() {
                        ...
                        // Reload the page with the new mode to get properly organized badges
    ...
    public function render_give_xp_form(): string {
        ...
        // New validation string for email invite
